...
class PromptForGeneration(nn.Module, GenerationMixin):
    ...
    def __init__(self,
        ...
        self.prompt_model = PromptModel(plm, template, freeze_plm = freeze_plm, plm_eval_mode = plm_eval_mode, tune_attn = tune_attn, prefix_only = prefix_only)
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        if "encoder_outputs" not in model_kwargs:
            ...
            if self.name == 'bart': model_inputs.pop('use_cache')
